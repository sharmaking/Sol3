# -*- coding: utf-8 -*-
#导入类库
from GetDataApi import GetDataApi, GetDataCallBack
...
class MySpi(GetDataCallBack):
	...
	def OnRecvCodes(self, codes, optionCodes):
		print "OnRecvCodes:"
		print len(codes), codes[0], codes[-1]["szCNName"]
		print len(optionCodes), optionCodes[0], optionCodes[-1]["basicCode"]["szCNName"]
		#print len(optionCodes), optionCodes[0]
...
def main():
	...
	#请求历史数据回放示例
	api.ReqSimulationData("2015-12-4 9:00:00", "2015-12-4 9:35:00", subcode, False);
